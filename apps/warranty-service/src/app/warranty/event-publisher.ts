...
export interface WarrantyEventPublisher {
  publish(envelope: EventEnvelope): Promise<void>;
  readonly published: EventEnvelope[];
}

export class InMemoryEventPublisher implements WarrantyEventPublisher {
  readonly published: EventEnvelope[] = [];
...
export class RabbitMqEventPublisher implements WarrantyEventPublisher {
