...
1. Mở **combined** http://localhost:8000/docs (hoặc http://localhost:8090/docs) — tags Identity…Reporting
2. Server: Kong `http://localhost:8000`
3. Login (Identity) → lấy `accessToken` → Authorize (Bearer)
4. Gọi endpoint protected theo tag service
5. Per-service debug vẫn dùng http://localhost:3001/docs … 3014/docs
