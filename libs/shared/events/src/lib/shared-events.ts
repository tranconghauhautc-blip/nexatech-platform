...
export const EventTypes = {
  ...
  WARRANTY_CLAIM_UPDATED: 'warranty.claim_updated',
  WARRANTY_CLAIM_APPROVED: 'warranty.claim_approved',
  WARRANTY_CLAIM_REJECTED: 'warranty.claim_rejected',
  WARRANTY_CLAIM_COMPLETED: 'warranty.claim_completed',
  WARRANTY_CLAIM_CANCELLED: 'warranty.claim_cancelled',
  WARRANTY_RETURN_REQUESTED: 'warranty.return_requested',
  WARRANTY_RETURN_UPDATED: 'warranty.return_updated',
  WARRANTY_RETURN_APPROVED: 'warranty.return_approved',
  WARRANTY_RETURN_REJECTED: 'warranty.return_rejected',
  WARRANTY_RETURN_COMPLETED: 'warranty.return_completed',
  WARRANTY_RETURN_CANCELLED: 'warranty.return_cancelled',
  /** Contract event — payment-service consumes later; warranty không gọi refund REST */
  WARRANTY_REFUND_REQUESTED: 'warranty.refund_requested',
  /** Contract event — inventory-service consumes later; warranty không gọi stock return REST */
  WARRANTY_INVENTORY_RETURN_REQUESTED: 'warranty.inventory_return_requested',
  ...
  SUPPORT_TICKET_CANCELLED: 'support.ticket_cancelled',
  SUPPORT_TICKET_MESSAGE_ADDED: 'support.ticket_message_added',
...
export const RoutingKeys: Record<EventType, string> = {
  ...
  [EventTypes.WARRANTY_CLAIM_UPDATED]: 'warranty.claim.updated',
  [EventTypes.WARRANTY_CLAIM_APPROVED]: 'warranty.claim.approved',
  [EventTypes.WARRANTY_CLAIM_REJECTED]: 'warranty.claim.rejected',
  [EventTypes.WARRANTY_CLAIM_COMPLETED]: 'warranty.claim.completed',
  [EventTypes.WARRANTY_CLAIM_CANCELLED]: 'warranty.claim.cancelled',
  [EventTypes.WARRANTY_RETURN_REQUESTED]: 'warranty.return.requested',
  [EventTypes.WARRANTY_RETURN_UPDATED]: 'warranty.return.updated',
  [EventTypes.WARRANTY_RETURN_APPROVED]: 'warranty.return.approved',
  [EventTypes.WARRANTY_RETURN_REJECTED]: 'warranty.return.rejected',
  [EventTypes.WARRANTY_RETURN_COMPLETED]: 'warranty.return.completed',
  [EventTypes.WARRANTY_RETURN_CANCELLED]: 'warranty.return.cancelled',
  [EventTypes.WARRANTY_REFUND_REQUESTED]: 'warranty.refund.requested',
  [EventTypes.WARRANTY_INVENTORY_RETURN_REQUESTED]:
    'warranty.inventory-return.requested',
  [EventTypes.SUPPORT_TICKET_CREATED]: 'support.ticket.created',
  [EventTypes.SUPPORT_TICKET_UPDATED]: 'support.ticket.updated',
  [EventTypes.SUPPORT_TICKET_ASSIGNED]: 'support.ticket.assigned',
  [EventTypes.SUPPORT_TICKET_RESOLVED]: 'support.ticket.resolved',
  [EventTypes.SUPPORT_TICKET_CLOSED]: 'support.ticket.closed',
  [EventTypes.SUPPORT_TICKET_CANCELLED]: 'support.ticket.cancelled',
  [EventTypes.SUPPORT_TICKET_MESSAGE_ADDED]: 'support.ticket.message.added',
